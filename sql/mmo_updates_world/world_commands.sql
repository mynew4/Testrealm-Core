...
REPLACE INTO `command` (`name`,`permission`,`help`) VALUES ('elite capital', 193, 'Syntax: .elite capital - teleport owner to capital(Orgrimmar/Stormwind) depending on faction of player');
