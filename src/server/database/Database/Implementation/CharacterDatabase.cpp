...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_INS_ANTWORTEN, "INSERT INTO spielerantworten (`spieler`, `playerid`, `accountid`, `fragennr`) VALUES(?,?,?,?)",CONNECTION_SYNCH);
    PrepareStatement(CHAR_SEL_ANTWORTEN, "SELECT `accountid` from spielerantworten where `fragennr` = ? AND `accountid` = ?", CONNECTION_ASYNC);
