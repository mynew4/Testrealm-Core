...
DELETE FROM `creature_questender` WHERE `id` = 800004 AND `quest` = 900001;
DELETE FROM `creature_queststarter` WHERE `id` = 800004   AND `quest` = 900001;
...
(/*  ID    */900001,
 ...
 /*  LogDescription  */  'Exitare sowie das komplette Team wuenscht Euch Happy Halloween.',
 /*  QuestDescription   */ 'Hallo $N, wir starten hier mit der ersten Quest des Halloweenevents. Hoert mir einfach nur zu.',
 /*  EndText   */  '',
 /*  OfferRewardText  */  'Happy Halloween.',
 /*  RequestItemsText  */ 'Happy Halloween.',
 /*  QuestCompletionLog  */ 'Happy Halloween.',
 /*  RequiredNpcOrGo1  */ 0,
 /*  RequiredNpcOrGo2  */ 0,
 /*  RequiredNpcOrGo3  */ 0,
 /*  RequiredNpcOrGo4  */ 0,
...
INSERT INTO `game_event_creature_quest` (`eventEntry`, `id`, `quest`) VALUES ('70', '800065', '900001');
