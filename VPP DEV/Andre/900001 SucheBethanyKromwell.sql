...
DELETE FROM `creature_questender` WHERE `id` = 33587   AND `quest` = 900001;
DELETE FROM `creature_queststarter` WHERE `id` = 32685   AND `quest` = 900001;
...
(/*  ID    */900001,
 ...
 /*  PointOption  */ 0,
 /*  LogTitle  */ 'Suche',
 /*  LogDescription  */  'Sucht Bethany Kromwell auf',
 /*  QuestDescription   */ 'Hallo $N, sucht Bethany Kromwell auf. Diese befindet sich in der Eiskrone beim Argentumtunierplatz in der nähe Übungspuppen auf.',
 /*  EndText   */  '',
 /*  OfferRewardText  */  'Findet ihr sie nicht?',
 /*  RequestItemsText  */ 'Sucht Bethany Kromwell auf',
