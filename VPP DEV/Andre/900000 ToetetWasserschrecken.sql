...
DELETE FROM `creature_questender` WHERE `id` = 32685   AND `quest` = 900000;
DELETE FROM `creature_queststarter` WHERE `id` = 32685   AND `quest` = 900000;
...
(/*  ID    */900000,
 ...
 /*  PointOption  */ 0,
 /*  LogTitle  */ 'Die Jagt',
 /*  LogDescription  */  'Tötet 20 Wasserschrecken',
 /*  QuestDescription   */ 'Hallo $N, Tötet 20 Wasserschrecken. Diese sind in der Eiskrone in Jotunheim zu finden',
 /*  EndText   */  '',
 /*  OfferRewardText  */  'Ist er zu schwer für Euch?',
 /*  RequestItemsText  */ 'Tötet 20 Wasserschrecken',
 /*  QuestCompletionLog  */ 'Es ist Eure Sache was ihr tut.',
 /*  RequiredNpcOrGo1  */ 30633,
 /*  RequiredNpcOrGo2  */ 0,
 /*  RequiredNpcOrGo3  */ 0,
 /*  RequiredNpcOrGo4  */ 0,
